...
# Seedream5 Lite - Text to Image

> High-quality photorealistic image generation powered by Seedream5 Lite's advanced AI model
...
````yaml market/seedream/5-lite-text-to-image.json post /api/v1/jobs/createTask
openapi: 3.0.0
info:
  title: Seedream API
  description: kie.ai Seedream5 Lite API Documentation - Text to Image
  version: 1.0.0
  contact:
...
paths:
  /api/v1/jobs/createTask:
    post:
      summary: Generate images using seedream/5-lite-text-to-image
            ...
            schema:
              ...
              properties:
                model:
                  ...
                  example: seedream/5-lite-text-to-image
                callBackUrl:
                  type: string
                  format: uri
                  description: >-
