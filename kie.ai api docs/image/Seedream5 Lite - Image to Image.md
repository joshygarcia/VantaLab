...
# Seedream5 Lite - Image to Image

> Image editing by Seedream5 Lite
...
<Tip>
  For production use, we recommend using the `callBackUrl` parameter to receive
  automatic notifications when generation completes, rather than polling the
  status endpoint.
</Tip>
...
````yaml market/seedream/5-lite-image-to-image.json post /api/v1/jobs/createTask
openapi: 3.0.0
info:
  title: Seedream API
  description: kie.ai Seedream5 Lite API Documentation - Image to Image
  version: 1.0.0
  contact:
...
paths:
  /api/v1/jobs/createTask:
    post:
      summary: Generate content using seedream/5-lite-image-to-image
              ...
              properties:
                model:
                  ...
                  description: |-
                    ...
                    - Must be `seedream/5-lite-image-to-image` for this endpoint
                  example: seedream/5-lite-image-to-image
                callBackUrl:
                  type: string
                  format: uri
                  description: >-
