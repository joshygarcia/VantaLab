                ...
                <div className="relative rounded-2xl border border-white/10 bg-[#0A0A0C]/95 backdrop-blur-xl p-8 shadow-2xl">
                    ...
                    <div className="space-y-3">
                        <input
                            ...
                            disabled
                            className="w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-sm text-white/30 placeholder:text-white/20 cursor-not-allowed"
                        />
                        <button
                            disabled
                            className="w-full rounded-xl border border-white/10 bg-white/5 px-6 py-3 text-sm font-medium text-white/30 cursor-not-allowed"
                        >
